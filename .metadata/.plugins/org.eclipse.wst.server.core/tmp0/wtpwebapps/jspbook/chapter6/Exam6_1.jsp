...
<body>
	...
	<form action="6_1" method="post">
		<p> 아이디 : <input type="text" name="id"><input type="botton" value="아이디 중복 검사">
		<p> 비밀번호 : <input type="password" name="passwd">
		<p> 이름 : <input type="text" name="name">
		<p> 연락처 : <input type="txt" mexlength="4" size="4" name="phone1">
				-
				<input type="text" maxlength="4" size="4" name="phone2">
				-
				<input type="text" mexlength="4" size="4" name="phone3">
