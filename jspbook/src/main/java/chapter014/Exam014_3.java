...
@WebServlet("/14_3")
public class Exam014_3 extends HttpServlet{

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("doGet 연결");
		RequestDispatcher rd = req.getRequestDispatcher("chapter14/Exam14_3_form.jsp");
		rd.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("chapter14/Exam14_3.jsp");
		rd.forward(req, resp);
	}
