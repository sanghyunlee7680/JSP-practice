...
<%
	System.out.println("2.addBook.jsp 도착");
%>
<!DOCTYPE html>
<html>
<head>
   ...
   <div class="p-5 mb-4 bg-body-tertiary rounded-3">
	 ...
	 <div class="row align-items-md-stretch">	 	
		...
		<form name="newBook" action="addBook" method="post" enctype ="multipart/form-data">
			...
			<div class="mb-3 row">
				<label class="col-sm-2"><fmt:message key="bookdescription" /></label>
				<div class="col-sm-5">
					<textarea  name="bookdescription" id="description" cols="50" rows="2"
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-5">
					<input type="radio" name="bookcondition" value="new " > <fmt:message key="condition_new" /> 
					<input type="radio" name="bookcondition" value="old" > <fmt:message key="condition_old" /> 
					<input type="radio" name="bookcondition" value="ebook" > <fmt:message key="condition_ebook" />
				</div>				
			</div>		
